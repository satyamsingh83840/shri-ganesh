...
type Product = {
  ...
  category: string;
  price: number;
  images: string[]; // Fixed: changed from image to images array
  featured?: boolean;
  bestseller?: boolean;
  description: string;
  features: string[];
...
export default function ProductCard({ product }: Props) {
  // Extract the first image securely with a safe placeholder fallback
  const displayImage =
